...
range(dataclean3$avgTotalCap, na.rm=TRUE)
...
print("total")
sd(dataRegroup20200404$avgTotalCap, na.rm=TRUE)
print("tools")
sd(dataRegroup20200404$avgTools, na.rm=TRUE)
print("skills")
sd(dataRegroup20200404$avgSkills, na.rm=TRUE)
print("infrastructure")
sd(dataRegroup20200404$avgStaffInfrastructure, na.rm=TRUE)
print("structures")
sd(dataRegroup20200404$avgStructuresSystems, na.rm=TRUE)
...
print("sd resident")
sd(avgResident1$avgTotalCap, na.rm=TRUE)
print("sd head")
sd(avgHead1$avgTotalCap, na.rm=TRUE)
...
print("sd female")
sd(avgFemale1$avgTotalCap, na.rm=TRUE)
print("sd male")
sd(avgMale1$avgTotalCap, na.rm=TRUE)
...
print("sd university")
sd(avgUniversity$avgTotalCap, na.rm=TRUE)
print("sd masters")
sd(avgMasters$avgTotalCap, na.rm=TRUE)
print("sd 2nd masters")
sd(avgMasters2$avgTotalCap, na.rm=TRUE)
...
print("total")
mean(dataclean3$avgTotalCap, na.rm=TRUE)
sd(dataclean3$avgTotalCap, na.rm=TRUE)
print("other")
mean(avgOther$avgTotalCap, na.rm=TRUE)
sd(avgOther$avgTotalCap, na.rm=TRUE)
print("anesthesia")
mean(avgAnesthesia$avgTotalCap, na.rm=TRUE)
sd(avgAnesthesia$avgTotalCap, na.rm=TRUE)
print("surgery")
mean(avgSurgery$avgTotalCap, na.rm=TRUE)
sd(avgSurgery$avgTotalCap, na.rm=TRUE)
print("internal")
mean(avgInternal$avgTotalCap, na.rm=TRUE)
sd(avgInternal$avgTotalCap, na.rm=TRUE)
print("radiology")
mean(avgRadiology$avgTotalCap, na.rm=TRUE)
sd(avgRadiology$avgTotalCap, na.rm=TRUE)
print("Trauma")
mean(avgTrauma$avgTotalCap, na.rm=TRUE)
sd(avgTrauma$avgTotalCap, na.rm=TRUE)
print("pathology")
mean(avgPathology$avgTotalCap, na.rm=TRUE)
sd(avgPathology$avgTotalCap, na.rm=TRUE)
print("pediatric")
mean(avgPediatrics$avgTotalCap, na.rm=TRUE)
sd(avgPediatrics$avgTotalCap, na.rm=TRUE)
print("obgyn")
mean(avgObgyn$avgTotalCap, na.rm=TRUE)
sd(avgObgyn$avgTotalCap, na.rm=TRUE)
...
print("mean and sd resident")
mean(avgResident$avgTotal, na.rm=TRUE)
sd(avgResident$avgTotal, na.rm=TRUE)
print("mean and sd head")
mean(avgHead$avgTotal, na.rm=TRUE)
sd(avgHead$avgTotal, na.rm=TRUE)
...
mean(clean4$avgTotal, na.rm=TRUE)
print("mean and sd anesthesia")
mean(avgAnesthesia1$avgTotal, na.rm=TRUE)
sd(avgAnesthesia1$avgTotal, na.rm=TRUE)
print("mean and sd peds")
mean(avgPediatrics1$avgTotal, na.rm=TRUE)
sd(avgPediatrics1$avgTotal, na.rm=TRUE)
print("mean and sd surgery")
mean(avgSurgery1$avgTotal, na.rm=TRUE)
sd(avgSurgery1$avgTotal, na.rm=TRUE)
print("mean and sd internal")
mean(avgInternal1$avgTotal, na.rm=TRUE)
sd(avgInternal1$avgTotal, na.rm=TRUE)
print("mean and sd trauma")
mean(avgTrauma1$avgTotal, na.rm=TRUE)
sd(avgTrauma1$avgTotal, na.rm=TRUE)
print("mean and sd obgyn")
mean(avgObgyn1$avgTotal, na.rm=TRUE)
sd(avgObgyn1$avgTotal, na.rm=TRUE)
print("mean and sd radiology")
mean(avgRadiology1$avgTotal, na.rm=TRUE)
sd(avgRadiology1$avgTotal, na.rm=TRUE)
print("mean and sd pathology")
mean(avgPathology1$avgTotal, na.rm=TRUE)
sd(avgPathology1$avgTotal, na.rm=TRUE)
print("mean and sd other")
mean(avgOther$avgTotal, na.rm=TRUE)
sd(avgOther$avgTotal, na.rm=TRUE)
...
sd(avgFemale2$avgTotal, na.rm=TRUE)
sd(avgMale2$avgTotal, na.rm=TRUE)
...
sd(avgUniversity1$avgTotal, na.rm=TRUE)
sd(avgMasters1$avgTotal, na.rm=TRUE)
sd(avgMasters12$avgTotal, na.rm=TRUE)
